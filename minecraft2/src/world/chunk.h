...
public:
    ...
    void SetNeighbors(std::shared_ptr<Chunk> nxp, std::shared_ptr<Chunk> nxm, std::shared_ptr<Chunk> nzp, std::shared_ptr<Chunk> nzm);
...
private:
    ...
    void AddGreedyQuad(std::vector<mc::render::Vertex>& vertices, std::vector<uint32_t>& indices, 
